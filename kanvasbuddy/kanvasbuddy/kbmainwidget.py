...
from .kbsliderbar import KBSliderBar
...
class KBMainWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.propSliders = KBSliderBar()
        self.initSliders()
        self.layout().addWidget(self.propSliders)        
    ...
    def initSliders(self):
        cfg = self._config.loadConfig('SLIDERS')
        for entry in cfg:
            if cfg.getboolean(entry):
                self.propSliders.addSlider(entry)
